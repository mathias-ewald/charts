...
![Version: 0.0.1](https://img.shields.io/badge/Version-0.0.1-informational?style=flat-square) ![AppVersion: v.2.1.2](https://img.shields.io/badge/AppVersion-v2.1.2-informational?style=flat-square)
...
* <https://hub.docker.com/repository/docker/mathiasewald/companion>
...
helm repo update
helm install companion k8s-at-home/companion
```

## Installing the Chart

To install the chart with the release name `companion`
...
To uninstall the `companion` deployment
...
```console
helm install companion \
    k8s-at-home/companion
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install companion k8s-at-home/companion -f values.yaml
```
...
| image.repository | string | `"mathiasewald/companion"` |  |
